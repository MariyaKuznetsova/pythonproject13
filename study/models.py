...
class Course(models.Model):
    ...
    price_course = models.PositiveIntegerField(verbose_name='Цена курса', blank=True, null=True)
...
class Lesson(models.Model):
    ...
    price_lesson = models.PositiveIntegerField(verbose_name='Цена урока', blank=True, null=True)
